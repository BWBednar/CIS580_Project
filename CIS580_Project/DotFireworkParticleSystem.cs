...
{
    class DotFireworkParticleSystem : ParticleSystem
    {
        ...
        Color color;
        public DotFireworkParticleSystem(Game game, int maxExplosions) : base(game, maxExplosions * 60)
        {
        ...
        protected override void UpdateParticle(ref Particle particle, float dt)
        {
            ...
            particle.Scale = 0.01f + 0.01f * normalizedLifetime;
        }
